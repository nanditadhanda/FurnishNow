    ...
    return (
        <Col md={3} xl={2} className="px-0 bg-light">     
                <Nav className="flex-column py-2 nav-side" variant="pills">   
                    <Nav.Link href={userType+"/dashboard"} className="px-4 " active>
                        <RiDashboardFill className="fs-3 pe-2 ms-1 mb-1 "/>Dashboard
                    </Nav.Link>
                    {userInfo.isSystemAdmin && (
                        <Nav.Link href="/admin/userlist" className="px-4 ">
                            <FiUsers className="fs-3 pe-2 ms-1 mb-1 "/>Users
                        </Nav.Link>
                    )}
                    <Nav.Link href={userType+"/productlist"} className="px-4 ">
                        <BiPackage className="fs-2 pe-2 mb-1 "/>Products
                    </Nav.Link>
                    <Nav.Link href={userType+"/orderlist"} className="px-4 ">
                        <RiMoneyDollarBoxLine className=" fs-2 pe-2 mb-1 "/>Orders
                    </Nav.Link>
                    <Nav.Link href={userType+"/reports"} className="px-4 ">
                        <GoGraph className=" fs-3 pe-2 ms-1 mb-1 "/>Reports
                    </Nav.Link>
                    <hr className="m-0"/>
                    <Nav.Link href="/profile" className="px-4 ">
